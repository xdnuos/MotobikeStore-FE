...
import { Container, Typography, Stack, Link, TextField, Grid, InputAdornment, IconButton } from '@mui/material'
      ...
      <Container>
        <Stack spacing={2} marginBottom='40px'>
          ...
          <Breadcrumbs separator="•" aria-label="breadcrumb">
            <Link underline="hover" color="text.primary" href="/dashboard/store">
              Store
            </Link>
        ...
        <form onSubmit={handleFormSubmit}>
          ...
          <Grid item xs={12} sx={{ display: 'flex', justifyContent: 'center' }} >
            <StyledButtonGreen type="submit" sx={{ mt: 3.5, height: '50px', width: '40%' }}>Submit</StyledButtonGreen>
          </Grid>
        </form>
      </Container>
    </>
